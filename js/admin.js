...
// Ví dụ thêm kiểm tra số sản phẩm mở khóa của người dùng
function checkUnlockedProducts() {
    let currentUser = JSON.parse(localStorage.getItem('currentuser'));
    let unlockedProducts = currentUser.unlockedProducts || [];
    console.log('Sản phẩm đã mở khóa:', unlockedProducts);
}
